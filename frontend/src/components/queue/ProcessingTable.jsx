...
function ProcessingTable() {
  return (
    ...
    >
      <div className="px-6 py-4 flex items-center justify-between border-b border-white/5 bg-surface-container">
        <div className="flex items-center gap-4">
          <h3 className="font-bold text-white">Active Processing Queue</h3>
      ...
      <div className="px-6 py-4 bg-[#0b0e14]/50 flex items-center justify-between border-t border-white/5">
