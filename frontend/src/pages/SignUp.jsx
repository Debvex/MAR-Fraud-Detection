...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-gray-900 via-gray-950 to-black flex flex-col items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md space-y-6">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start gap-3 px-1">
              <input
                type="checkbox"
                className="mt-1 w-4 h-4 rounded border-white/10 bg-black/40 checked:bg-blue-600 transition-all cursor-pointer"
                id="terms"
              />
              <label
                htmlFor="terms"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(37,99,235,0.3)] transition-all mt-4"
            >
          ...
          {/* Social Login */}
          <div className="w-full flex justify-center items-center bg-white/5 border border-white/10 rounded-xl p-3 hover:bg-white/10 hover:border-white/20 transition-all">
            <GoogleLogin
        ...
        <div className="flex justify-center items-center gap-4 text-gray-600">
          <div className="flex items-center gap-1.5 text-[10px] uppercase font-bold tracking-tighter">
            <ShieldCheck size={14} className="text-green-500/50" /> End-to-End
            Encrypted
          </div>
        </div>
      </div>
